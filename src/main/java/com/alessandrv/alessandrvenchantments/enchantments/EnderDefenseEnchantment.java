...
public class EnderDefenseEnchantment extends Enchantment {
    ...
    public boolean canAccept(Enchantment other) {
        return !(other instanceof MobGuardEnchantment || other instanceof RingOfFireEnchantment || other instanceof ExplosiveEnchantment);
    }
    @Override
                            ...
                            if (livingEntity instanceof HostileEntity) {
                                ...
                                if (hostileEntity.getTarget() == user) {
                                    ...
                                    for (int i = 0; i < 16; ++i) {
                                        ...
                                        if (hostileEntity.hasVehicle()) {
                                            hostileEntity.stopRiding();
                                        }
